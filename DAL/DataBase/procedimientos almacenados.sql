...
ALTER PROCEDURE spu_modificar_producto
	@idproducto		 INT,
	@idMarca		 INT,
	@idCategoria	 INT,
	@nombreproducto  VARCHAR(50),
...
AS BEGIN
		...
		Empleados.estado
		FROM Empleados
		INNER JOIN Personas ON Personas.idpersona = Empleados.idempleado
		WHERE Empleados.nombreusuario = @nombreusuario AND
			Empleados.estado = 1
END
GO

EXEC spu_usuario_login 'lucio'
GO