...
--Contraseña-farfan123
UPDATE Empleados SET
claveacceso = '$2a$06$nHSExH.JrqZVegdk.fd9g.tn5xpmcUBQLdKobcuriIA7tBzQZIp4O'
WHERE idpersona = 1
GO
--Contraseña-medina123
UPDATE Empleados SET
claveacceso = '$2a$06$BWfYDkOVJXuVClolYjaII.R7K7r9Dk5rZQoOC4fGKZO4RESSZ1oGm'
WHERE idpersona = 4
GO
--Contraseña-mateo123
UPDATE Empleados SET
claveacceso = '$2a$06$4E6uckwvhXt2rhPWxAMRdOsgjlLteSx9MOf1NSwgCTXu8p3ds5KnG'
WHERE idpersona = 3
GO